 ...
 */
final class Version20220302223326 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, tag_id INT NOT NULL, reserved_by_id INT DEFAULT NULL, urls LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, cover_filename VARCHAR(255) DEFAULT NULL, price DOUBLE PRECISION NOT NULL, reserved_text LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_23A0E66BAD26311 (tag_id), INDEX IDX_23A0E66BCDB4AF4 (reserved_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
